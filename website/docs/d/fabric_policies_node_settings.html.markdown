...
* `synce` - (Read-Only) The Synchronous Ethernet (SyncE) configuration block of the Node Settings.
...
* `ptp` - (Read-Only) The Precision Time Protocol (PTP) configuration block of the Node Settings.
