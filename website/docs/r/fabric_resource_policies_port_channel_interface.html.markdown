...
An existing MSO Fabric Resource Policies Port Channel Interface Policy can be [imported][docs-import] into this resource via its ID, using the following command:
