...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"mso_schema_site_template_contract_service_graph": resourceMSOSchemaSiteTemplateContractServiceGraph(),
		},
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"mso_schema_site_template_contract_service_graph": dataSourceMSOSchemaSiteTemplateContractServiceGraph(),
		},
