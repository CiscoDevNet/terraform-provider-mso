		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.mso_tenant_policies_route_map_policy_multicast.route_map_policy_multicast", "route_map_entries_multicast.#", "1"),
					customTestCheckResourceTypeSetAttr("data.mso_tenant_policies_route_map_policy_multicast.route_map_policy_multicast", "route_map_entries_multicast",
						map[string]string{
							"order":     "1",
