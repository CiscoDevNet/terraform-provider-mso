...
// resourceMSOSchemaSiteVrf manages an mso_schema_site_vrf association
// (a template VRF surfaced under a specific site on the schema).
//
...
// Once a template VRF exists and the template is associated with a site,
// NDO automatically materializes the corresponding sites[].vrfs[] entry on
