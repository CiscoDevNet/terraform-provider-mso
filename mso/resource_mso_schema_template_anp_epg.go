					...
					for k := 0; k < epgCount; k++ {
						...
						if apiEPG == stateEPG {
							...
							if d.Get("epg_type") == "service" {
								...
								d.Set("cloud_service_epg_config", assign_empty)
							}
