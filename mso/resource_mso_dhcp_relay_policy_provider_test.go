...
// 			},
// 			{
// 				Config: MSODHCPRelayPolicyProviderWithExtEpg(tenantNames[0], nameOther, addr),
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckMSODHCPRelayPolicyProviderExists(resourceName, &prov2),
...
// 			},
// 			{
// 				Config: MSODHCPRelayPolicyProviderWithExtEpg(tenantNames[0], name, addrOther),
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckMSODHCPRelayPolicyProviderExists(resourceName, &prov2),
// 					resource.TestCheckResourceAttr(resourceName, "dhcp_relay_policy_name", nameOther),
...
// 		Steps:        []resource.TestStep{
// 			{
// 				Config: MSODHCPRelayPolicyProviderWithEpgMutliple(tenantNames[0],name,epg),
// 			},
// 		},
// 	})
// }
...
// func MSODHCPRelayPolicyProviderWithEpgMutliple(tenant,name){}
