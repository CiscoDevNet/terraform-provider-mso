	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Config:    testAccMSOTenantPoliciesMcastRouteMapPolicyConfigUpdateSlaTypeWithICMP(),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("mso_tenant_policies_ipsla_monitoring_policy.ipsla_policy", "name", "test_ipsla_policy"),
			...
			},
			{
				...
				Config:    testAccMSOTenantPoliciesMcastRouteMapPolicyConfigUpdateSlaTypeWithL2Ping(),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("mso_tenant_policies_ipsla_monitoring_policy.ipsla_policy", "name", "test_ipsla_policy"),
			...
			},
			{
				...
				Config:    testAccMSOTenantPoliciesMcastRouteMapPolicyConfigUpdateSlaTypeWithTCP(),
				Check: resource.ComposeTestCheckFunc(
		...
		CheckDestroy: testCheckResourceDestroyPolicyWithArguments("mso_tenant_policies_ipsla_monitoring_policy", "McastRouteMapPolicy"),
	})
}
...
func testAccMSOTenantPoliciesMcastRouteMapPolicyConfigUpdateSlaTypeWithICMP() string {
	return fmt.Sprintf(`%s
	resource "mso_tenant_policies_ipsla_monitoring_policy" "ipsla_policy" {
	    template_id        = mso_template.template_tenant.id
	    name               = "test_ipsla_policy"
...
func testAccMSOTenantPoliciesMcastRouteMapPolicyConfigUpdateSlaTypeWithL2Ping() string {
	return fmt.Sprintf(`%s
	resource "mso_tenant_policies_ipsla_monitoring_policy" "ipsla_policy" {
	    template_id        = mso_template.template_tenant.id
	    name               = "test_ipsla_policy"
...
func testAccMSOTenantPoliciesMcastRouteMapPolicyConfigUpdateSlaTypeWithTCP() string {
	return fmt.Sprintf(`%s
	resource "mso_tenant_policies_ipsla_monitoring_policy" "ipsla_policy" {
	    template_id        = mso_template.template_tenant.id
