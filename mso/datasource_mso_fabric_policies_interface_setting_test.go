		...
		Steps: []resource.TestStep{

			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.mso_fabric_policies_interface_setting."+msoFabricPolicyTemplateInterfaceSettingName+"_portchannel", "domains.#", "1"),
					resource.TestCheckResourceAttrSet("data.mso_fabric_policies_interface_setting."+msoFabricPolicyTemplateInterfaceSettingName+"_portchannel", "synce"),
					resource.TestCheckResourceAttrSet("data.mso_fabric_policies_interface_setting."+msoFabricPolicyTemplateInterfaceSettingName+"_portchannel", "access_macsec_policy"),
				),
			},
		},
	})
